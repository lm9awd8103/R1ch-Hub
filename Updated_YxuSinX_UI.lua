...
function Kavo:BGLoader(id)
	for i,v in pairs(game.CoreGui:FindFirstChild("HubDestroyer"):GetDescendants()) do
		...
		else if v.Name:find("MainSide") or v.Name:find("sectionHead") or v.Name:find("sectionFrame") or v.Name=="Page" then
...
BackgroundImage.BackgroundTransparency = 1  -- No background
BackgroundImage.Position = UDim2.new(0, 0, 0, 0)
BackgroundImage.Size = UDim2.new(1, 0, 1, 0)                
BackgroundImage.ZIndex = 10  -- Keep background below text
BackgroundImage.Image = "rbxassetid://115999273037408"
BackgroundImage.ScaleType = Enum.ScaleType.Crop
BackgroundImage.ImageTransparency = 0.85  -- More faded background for better text visibility

-- Function to adjust transparency and layering
local function adjustTransparency(parent)
    for _, v in pairs(parent:GetDescendants()) do
        if v:IsA("Frame") or v:IsA("ImageButton") then
            -- Make frames and buttons semi-transparent
            v.BackgroundTransparency = math.min(v.BackgroundTransparency + 0.5, 0.8)
        elseif v:IsA("TextLabel") then
            -- Make text fully visible and set a high ZIndex
            v.BackgroundTransparency = 1
            v.TextTransparency = 0
            v.ZIndex = 100  -- Ensure text is above everything
            v.TextStrokeTransparency = 0  -- Fully visible text outline
            v.TextStrokeColor3 = Color3.new(0, 0, 0)  -- Black outline for contrast
        elseif v:IsA("TextButton") then
            -- Keep text buttons readable
            v.BackgroundTransparency = 1
            v.TextTransparency = 0
            v.ZIndex = 50  -- Keep it above most elements but below text labels
        end
    end
end
...
adjustTransparency(Main)

-- Force text visibility after a short delay to override any UI updates
task.wait(0.1)
adjustTransparency(Main)

-- Add other UI elements (tabs, sections, buttons, etc.)
...
-- Add other UI elements (tabs, sections, buttons, etc.)
    ...
    title.Size = UDim2.new(0, 210, 0, 9)
  ...
  title2.Name = "title2"
    title2.Parent = MainHeader
    title2.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    title2.BackgroundTransparency = 1.000
    title2.BorderSizePixel = 0
    title2.Position = UDim2.new(0, 170, 0, 7)
    title2.Size = UDim2.new(0, 204, 0, 8)
    title2.Font = Enum.Font.FredokaOne
    title2.RichText = true
    title2.Text = " Made by xLM9AWD"
    title2.TextColor3 = Color3.fromRGB(255, 218, 31)
...
local Corner3 = Instance.new("UICorner")
    ...
    Logo.Position = UDim2.new(0, 10, 0, 3)
    Logo.Size = UDim2.new(0, 30, 0, 25)
    Logo.ZIndex = 2
    Logo.Image = "http://www.roblox.com/asset/?id=115999273037408"
